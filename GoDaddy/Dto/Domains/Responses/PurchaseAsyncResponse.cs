...
public sealed class PurchaseAsyncResponse
{
    ...
    public PurchaseAsyncResponse(JsonNode? raw, JsonObject? @object, JsonArray? items, string? code, string? message)
    {
        Raw = raw;
        Object = @object;
        Items = items;
    ...
    public static PurchaseAsyncResponse FromJson(JsonNode? raw)
    {
        ...
        return new PurchaseAsyncResponse(raw, @object, items, code, message);
    }
}
