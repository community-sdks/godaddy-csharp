...
public sealed class TldsAsyncResponse
{
    ...
    public TldsAsyncResponse(JsonNode? raw, JsonObject? @object, JsonArray? items, string? code, string? message)
    {
        Raw = raw;
        Object = @object;
        Items = items;
    ...
    public static TldsAsyncResponse FromJson(JsonNode? raw)
    {
        ...
        return new TldsAsyncResponse(raw, @object, items, code, message);
    }
}
