...
public sealed class ListAsyncResponse
{
    ...
    public ListAsyncResponse(JsonNode? raw, JsonObject? @object, JsonArray? items, string? code, string? message)
    {
        Raw = raw;
        Object = @object;
        Items = items;
    ...
    public static ListAsyncResponse FromJson(JsonNode? raw)
    {
        ...
        return new ListAsyncResponse(raw, @object, items, code, message);
    }
}
