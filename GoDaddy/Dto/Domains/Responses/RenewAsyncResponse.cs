...
public sealed class RenewAsyncResponse
{
    ...
    public RenewAsyncResponse(JsonNode? raw, JsonObject? @object, JsonArray? items, string? code, string? message)
    {
        Raw = raw;
        Object = @object;
        Items = items;
    ...
    public static RenewAsyncResponse FromJson(JsonNode? raw)
    {
        ...
        return new RenewAsyncResponse(raw, @object, items, code, message);
    }
}
