...
public sealed class ValidateAsyncResponse
{
    ...
    public ValidateAsyncResponse(JsonNode? raw, JsonObject? @object, JsonArray? items, string? code, string? message)
    {
        Raw = raw;
        Object = @object;
        Items = items;
    ...
    public static ValidateAsyncResponse FromJson(JsonNode? raw)
    {
        ...
        return new ValidateAsyncResponse(raw, @object, items, code, message);
    }
}
