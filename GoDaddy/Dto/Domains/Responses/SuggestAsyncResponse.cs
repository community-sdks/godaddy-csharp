...
public sealed class SuggestAsyncResponse
{
    ...
    public SuggestAsyncResponse(JsonNode? raw, JsonObject? @object, JsonArray? items, string? code, string? message)
    {
        Raw = raw;
        Object = @object;
        Items = items;
    ...
    public static SuggestAsyncResponse FromJson(JsonNode? raw)
    {
        ...
        return new SuggestAsyncResponse(raw, @object, items, code, message);
    }
}
