...
public sealed class SchemaAsyncResponse
{
    ...
    public SchemaAsyncResponse(JsonNode? raw, JsonObject? @object, JsonArray? items, string? code, string? message)
    {
        Raw = raw;
        Object = @object;
        Items = items;
    ...
    public static SchemaAsyncResponse FromJson(JsonNode? raw)
    {
        ...
        return new SchemaAsyncResponse(raw, @object, items, code, message);
    }
}
